...
public function AvaTaxAddressValidation($data) {
					...
					$address_data["line1"] = $data["address_1"];
					$address_data["line2"] = $data["address_2"];
					$address_data["line3"] = "";
					$address_data["city"] = $data["city"];
					$address_data["region"] = $zone_info["code"];
					$address_data["postalcode"] = $data["postcode"];
...
if(isset($this->request->post['payment_address'])&& $this->request->post['payment_address']=="new"){
                                                        $res=$this->AvaTaxAddressValidation($this->request->post);
                                                        }
                                                        else
                                                        {
